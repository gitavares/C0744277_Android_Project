 ...
 */
public class InboxFragment extends Fragment implements IDataOperations {
    ...
    public void update(String taskId, Boolean isDone) {
        ...
        InboxFragment.sAppDatabase.mTaskDAO().updateTaskStatus(taskId, isDone, today.getTime());
    }
}
